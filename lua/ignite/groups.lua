...
function group.get()
  ...
  local groups = {
    ...
    DiagnosticUnderlineError    = { fg = pallet.red },
    DiagnosticUnderlineWarn     = { fg = pallet.yellow },
    DiagnosticUnderlineInfo     = { fg = pallet.dark_green },
    DiagnosticUnderlineHint     = { fg = pallet.light_blue },
    ...
    DiagnosticTextHint          = { fg = pallet.light_blue },
