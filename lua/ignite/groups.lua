...
function M.get_groups()
  ...
  local groups = {
    ...
    SpecialComment = { fg = pallet.operator, bg = pallet.background3 },
    Debug = { fg = pallet.type },

    Underlined = { fg = pallet.keyword, underline = style.underline },
    Ignore = { fg = pallet.comment },
    Error = { fg = pallet.keyword, bg = pallet.background3 },
    Todo = { fg = pallet.string, bg = pallet.background3 },
    ...
    ["@text.todo"] = { link = "Todo" },
    ["@text.todo.checked"] = { fg = pallet.string, bg = pallet.background3 },
    ["@text.todo.unchecked"] = { fg = pallet.comment, bg = pallet.background3 },
    ...
    ["@lsp.type.struct"] = { fg = pallet.type },
    ["@lsp.type.type"] = { fg = pallet.type },
    ...
    ["@string.special.path"] = { underline = style.underline },
    ["@string.special.url"] = { underline = style.underline },
    ...
    ["@type"] = { fg = pallet.type },
    ["@type.builtin"] = { fg = pallet.keyword },
    ["@type.definition"] = { fg = pallet.type },
    ...
    ["@markup.italic"] = { fg = pallet.property, italic = true },
    ["@markup.strong"] = { fg = pallet.property, bold = true },

    ["@markup.heading.1"] = { fg = pallet.method, bold = true },
    ["@markup.heading.2"] = { fg = pallet.method, bold = true },
    ["@markup.heading.3"] = { fg = pallet.keyword, bold = true },
    ["@markup.heading.4"] = { fg = pallet.keyword, bold = true },
    ["@markup.heading.5"] = { fg = pallet.keyword, bold = true },
    ["@markup.heading.6"] = { fg = pallet.keyword, bold = true },

    ["@markup.raw"] = { fg = pallet.string },                                      -- Inline code
    ["@markup.raw.block"] = { fg = pallet.string },                                -- Code blocks
    ["@markup.quote"] = { fg = pallet.text2 },                                     -- Blockquotes and Lists
    ["@markup.list"] = { fg = pallet.text2 },
    ["@markup.link.label"] = { fg = pallet.module, underline = config.underline }, -- Links
    ["@markup.link.url"] = { fg = pallet.module },
    ...
    markdownItalic = { fg = pallet.text, italic = true },
    markdownBold = { fg = pallet.text, bold = config.bold },
    markdownBoldItalic = { fg = pallet.text, bold = config.bold, italic = true },
    markdownH1 = { fg = pallet.method, bold = config.bold },
    markdownH2 = { fg = pallet.method, bold = config.bold },
    markdownH3 = { fg = pallet.type, bold = config.bold },
    markdownH4 = { fg = pallet.type, bold = config.bold },
    markdownH5 = { fg = pallet.constant, bold = config.bold },
    markdownH6 = { fg = pallet.constant, bold = config.bold },
    markdownCode = { fg = pallet.string },
    markdownCodeBlock = { fg = pallet.string },
    markdownCodeDelimiter = { fg = pallet.string },
    markdownBlockquote = { fg = pallet.text2 },
    markdownListMarker = { fg = pallet.text2 },
    markdownOrderedListMarker = { fg = pallet.text2 },
    markdownRule = { fg = pallet.text2 },
    markdownHeadingRule = { fg = pallet.text2 },
    markdownUrlDelimiter = { fg = pallet.type },
    markdownLinkDelimiter = { fg = pallet.type },
    markdownLinkTextDelimiter = { fg = pallet.type },
    markdownHeadingDelimiter = { fg = pallet.method },
    markdownUrl = { fg = pallet.macro },
    markdownUrlTitleDelimiter = { fg = pallet.text2 },
    markdownLinkText = { fg = pallet.text2, underline = config.underline },
    ...
    NoiceConfirm = { link = "NoiceCmdline" },
    NoiceConfirmBorder = { link = "NoiceConfirmBorder" },
    ...
    NoiceMini = { fg = pallet.text, bg = "NONE" },
    ...
    MiniIndentscopeSymbol = { fg = pallet.background3 },

    IblIndent = { fg = pallet.background3 },
    IblWhitespace = { fg = pallet.background2 },
    IblScope = { fg = pallet.background3 },
  }
